...
class flat extends StatefulWidget {
  ...
  flat(this.isThisForUpdate, this.isThisView, this.hostelID, this.pageType);

  @override
  State<StatefulWidget> createState() {
    return FlatPage(isThisForUpdate, isThisView, hostelID, pageType);
  }
}

class FlatPage extends State<flat> {
  bool? isThisForUpdate;
  bool? isThisView;
  String? hostelID;
  String? pageType;
  ...
  FlatPage(this.isThisForUpdate, this.isThisView, this.hostelID, this.pageType);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isThisForUpdate!
            ? Text(isThisView! ? "View Flat" : "Update Flat")
                                        ...
                                        if (latitude.isNotEmpty &&
                                          ...
                                          if (isLength(ownerName.text, 1)) {
                                            ...
                                            if (isLength(
                                              ...
                                              if (isLength(alternateNumber.text,
                                                      10) ||
                                                  alternateNumber
                                                      .text.isEmpty) {
  ...
  //     setState(() {
  //       positions = index;
  //       descriValue.add('This Field is required');
  //       check = true;
  //     });
  //   } else {
  //     setState(() {
