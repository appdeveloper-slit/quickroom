...
class Add extends StatefulWidget {
  ...
  Add(this.isThisForUpdate, this.isThisView, this.hostelID, this.pageType);

  @override
  State<StatefulWidget> createState() {
    return AddPage(isThisForUpdate, isThisView, hostelID, pageType);
  }
}
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isThisForUpdate!
            ? Text(isThisView!?"View Hostel":"Update Hostel")
            ...
            child: Column(
              ...
              children: [
                                        ...
                                        onTap: () {
                                          if (diffChargList
                                            ...
                                            setState(() {
                                              ...
                                              priceCtrl[index].clear();
                                              descripCtrl[index].clear();
                                            });
                                          } else {
                                            setState(() {
                                              diffChargList.add({
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText: 'Enter hostel leaving policy',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
