...
class Pgflat extends StatefulWidget {
  bool? isThisForUpdate;
  bool? isThisView;
  String? hostelID;
  String? pageType;

  Pgflat(this.isThisForUpdate, this.isThisView, this.hostelID, this.pageType);

  @override
  State<StatefulWidget> createState() {
    return PgFlatPage(isThisForUpdate, isThisView, hostelID, pageType);
  }
}

class PgFlatPage extends State<Pgflat> {
  bool? isThisForUpdate;
  bool? isThisView;
  String? hostelID;
  String? pageType;
  ...
  TextEditingController _otherCapacity = TextEditingController();
  ...
  String sGender = "Boys PG Flat";

  List<String> actionList = ["1RK", "1BHK", "2BHK", "3BHK"];
  List<TextEditingController> priceCtrl = [];
  List<TextEditingController> capacityCtrl = [];
  ...
  void getHostel() async {
    ...
    if (res['error'] != true) {
      ...
      rule = res['hostel']['condition'] == null ? [] : res['hostel']['condition'];
      facility2 =  res['hostel']['facility'] == null ? [] : res['hostel']['facility'];
      ...
      for (int a = 0; a < aa.length; a++) {
        if (actionList
          ...
          capacityCtrl[position] = TextEditingController(text: aa[a]['capacity']);
          ...
          _otherCapacity = TextEditingController(text: aa[a]['capacity']);
  ...
  void updateHostel(
    ...
    try {
      ...
      print('Upadte Hostel :${formData.fields}');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isThisForUpdate!
            ? Text(isThisView! ? "View PG Flat" : "Update PG Flat")
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText: 'Enter total vacant PG places *',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              capacityCtrl.add(TextEditingController());
                ...
                // SizedBox(height: 20),
                Text(
                  'Why resident will select this ${widget.pageType} ?',
                  style: Sty()
                      .mediumText
                      .copyWith(fontSize: 15, fontWeight: FontWeight.w500),
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText:
                    'Enter why resident will select this ${widget.pageType} ',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
                ...
                SizedBox(height: 20),
                Text(
                  'More about this ${widget.pageType}',
                  style: Sty()
                      .mediumText
                      .copyWith(fontSize: 15, fontWeight: FontWeight.w500),
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText:
                    'Enter More about  ${widget.pageType}',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText: 'Enter apartment leaving policy',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
                        ...
                        if(formkey.currentState!.validate()){
                          for(int a = 0; a < diffChargList.length; a++){
                            ...
                            changeList.add({
                              ...
                              "capacity": capacityCtrl[position].text,
                            });
                          }
                          print(changeList);
                          var aa;
  ...
  validatoeForm(index) {
    ...
    if (priceCtrl[index].text.isEmpty) {
      setState(() {
        ...
        // capacityValue.add('This Field is required');
        check = false;
      });
    } else {
      setState(() {
    ...
    }if (capacityCtrl[index].text.isEmpty) {
      setState(() {
        positions = index;
        // priceValue.add('This Field is required');
        capacityValue.add('This Field is required');
      ...
      if (diffChargList
        ...
        setState(() {
          diffChargList.add({
            "type": actionList[index],
            "charge": priceCtrl[index].text,
            "capacity": capacityCtrl[index].text,
            "description": descripCtrl[index].text,
          });
        });
        print(diffChargList);
