...
class PgRoom extends StatefulWidget {
  bool? isThisForUpdate;
  bool? isThisView;
  String? hostelID;
  String? pageType;

  PgRoom(this.isThisForUpdate, this.isThisView, this.hostelID, this.pageType);

  @override
  State<StatefulWidget> createState() {
    return PgRoomPage(isThisForUpdate, isThisView, hostelID, pageType);
  }
}

class PgRoomPage extends State<PgRoom> {
  bool? isThisForUpdate;
  bool? isThisView;
  String? hostelID;
  String? pageType;
  ...
  List<String> actionList = ["01 person", "02 person", "03 person", "04 person","05 person","06 person"];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isThisForUpdate!
            ? Text(isThisView!?"View PG Room":"Update PG Room")
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText: 'Enter total vacant places',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
                ...
                // SizedBox(height: 20),
                Text(
                  'Why resident will select this room ?',
                  style: Sty()
                      .mediumText
                      .copyWith(fontSize: 15, fontWeight: FontWeight.w500),
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10),
                    hintText:
                    'Enter why resident will select this room ',
                    hintStyle: TextStyle(fontSize: 13),
                    border: InputBorder.none,
                    fillColor: Colors.black12,
                    filled: true,
